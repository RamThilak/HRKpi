<%@ Page Title="" Language="C#" MasterPageFile="~/MainMenu.Master" AutoEventWireup="true" CodeBehind="ResetUserPassword.aspx.cs" Inherits="HRKpi.ResetUserPassword" %>
         ...
         <div class="card-body">
            <form>
                 ...
                 <div style="margin-top:15px; text-align: right;">  
                         <asp:Button ID="button_add" runat="server" Font-Bold="True" Font-Size="Small" Text="Reset Password" OnClick="button_add_Click" />
&nbsp;
