<%@ Page Title="" Language="C#" MasterPageFile="~/MainMenu.Master" AutoEventWireup="true" CodeBehind="CreateLogin.aspx.cs" Inherits="HRKpi.CreateLogin" %>
         ...
         <div class="card-body">
            <form>
                 ...
                 <div style="margin-top:15px; text-align: right;">  
                         <asp:Button ID="button_add" runat="server" Font-Bold="True" Font-Size="Small" Text="Create" OnClick="button_add_Click" />
&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
                         ...
                         <tr>
                             <td style="width: 178px; ">
                                   <asp:CheckBox ID="chkkpi" runat="server" Font-Bold="True" Font-Size="Small" Text="Create KPI Login" />
                             </td>
